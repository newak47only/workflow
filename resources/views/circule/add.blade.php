	...
	<div class="wap-container">
		<div class="panel">
			<div class="panel-body">
				<form action="{{route('circule.store')}}" method="post" class="form form-horizontal" id="form-admin-add">
					...
					<div class="row clearfix">
						...
						<div class="form-controls col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="{{$informations->investment}} " placeholder="{{$informations->investment}}" id="Landing_investment" name="investment" datatype="*4-16" >
