	...
	<div class="wap-container">
		<div class="panel">
			<div class="panel-body">
				<form action="{{route('completion.store')}}" method="post" class="form form-horizontal" id="form-admin-add">
					<div class="row clearfix">
						<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>项目名称：</label>
						<div class="form-controls col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="{{$informations->name}}" placeholder="{{$informations->name}}" id="report_name" name=" " required>
						</div>
					</div>
					<div class="row clearfix">
						<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>投资金额：</label>
						<div class="form-controls col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="{{$informations->investment}} " placeholder="{{$informations->investment}}" id="report_investment" name=''  >
					...
					<div class="row clearfix">
						<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>投产时间：</label>
						<div class="form-controls col-xs-8 col-sm-9">
					...
					<div class="row clearfix">
						<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>投产说明：</label>
						<div class="form-controls col-xs-8 col-sm-9">
				...
				submitHandler:function(form){
					$(form).ajaxSubmit({
						...
						success:function(data){
							if( data == '1'){
								layer.msg('项目投产成功！',{ icon: 1,time:2000},function(){
								...
								layer.msg('项目投产失败！',{ icon: 2,time:2000});
							}
						},
						error:function(XmlHttpRequest,textStatus,errorThrown){
							layer.msg('项目投产错误！',{ icon: 1,time:1000});
						},
					});
				},
			});
