	...
	<div class="wap-container">
		<div class="panel">
			<div class="panel-body">
				<form action="{{Route('permission.store')}}" method="post" class="form form-horizontal" id="form-permission-add">
					{{ csrf_field() }}
					{{method_field('POST')}}
				...
				submitHandler:function(form){
					$(form).ajaxSubmit({
						success:function(data){
							if( data == '1'){
								layer.msg('权限添加成功！',{ icon: 1,time:2000},function(){
								...
								layer.msg('权限添加失败！',{ icon: 2,time:2000});
							}
						},
						error:function(XmlHttpRequest,textStatus,errorThrown){
							layer.msg('权限添加错误！',{ icon: 1,time:2000});
						}
					});
				}
