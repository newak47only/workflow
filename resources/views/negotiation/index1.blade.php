			...
			<div class="panel ">
				<div class="panel-body">
					<div id="tab-system" class="HuiTab">
						<div class="tabBar cl"><span>本区全程项目</span><span>本区流转项目</span><span>本区首谈地项目</span></div>
						<div class="tabCon">
									...
									<tbody>
										...
										@endif</td>
											...
											<td class="td-manage">
												...
												@elseif($v['process']==5)
												<button type="submit"  href="javascript:;" onclick="')"  class=" f-l ml-10 btn btn-success radius size-S"><i class="Hui-iconfont">&#xe6df;</i>&nbsp;&nbsp;&nbsp;&nbsp;已开工&nbsp;&nbsp;</button>
												@elseif($v['process']==6)
