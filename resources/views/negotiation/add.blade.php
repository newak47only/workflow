		...
		<div class="panel">
			<div class="panel-body">
				...
				<div class="row clearfix">
					...
					<div class="form-controls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="{{$informations->investment}} " placeholder="{{$informations->investment}}" id="negotiation_investment" name="" datatype="*4-16" >
				...
				<div class="row clearfix">
					<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>签约时间：</label>
					<div class="form-controls col-xs-8 col-sm-9">
