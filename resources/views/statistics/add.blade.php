	...
	<div class="wap-container">
		<div class="panel">
			<div class="panel-body">
				<form action="{{route('statistics.store')}}" method="post" class="form form-horizontal" id="form-admin-add">
					{{csrf_field()}}
					{{method_field('POST')}}
				<div class="row clearfix">
					<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>项目名称：</label>
					<div class="form-controls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="{{$informations->name}}" placeholder="{{$informations->name}}" id="negotiation_name" name="  "  >
					</div>
				</div>
				<div class="row clearfix">
					<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>投资金额：</label>
					<div class="form-controls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="{{$informations->investment}} " placeholder="{{$informations->investment}}" id="negotiation_investment" name=" "  >
				...
				<div class="row clearfix">
					<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>绩效年度：</label>
					<div class="form-controls col-xs-8 col-sm-9">
						<input type="text" class="input-text " value="" placeholder="" id=" " name="year"  >
						<span class="c-red">填写说明：</span>填写数据指标年度，例如2019
					</div>
				</div>
				<div class="row clearfix">
					<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>数据类型：</label>
					<div class="form-controls col-xs-8 col-sm-9">
						<select class="select input-text"  name="data_type" size="1">
				...
				<div class="row clearfix">
					...
					<div class="form-controls col-xs-8 col-sm-9">
						<select class="select input-text"  name="currency" size="1">
				...
				<div class="row clearfix">
					<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>数据内容：</label>
					<div class="form-controls col-xs-8 col-sm-9">
						<input type="text" class="input-text " value="" placeholder="" id=" " name="data" >
						<span class="c-red">填写说明：</span>填写数字，不用填写金额单位，默认单位（万元）
					</div>
				</div>
				...
				<input type="hidden"  value="{{$users->id}}" placeholder="" id=" " name="emp_id" >
					...
					$(form).ajaxSubmit({
						...
						success:function(data){
							if( data == '1'){
								...
								layer.msg('绩效添加失败！',{ icon: 2,time:2000});
							}
						},
						error:function(XmlHttpRequest,textStatus,errorThrown){
							layer.msg('绩效添加错误！',{ icon: 1,time:1000});
						},
					});
				},
			});
