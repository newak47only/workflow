	...
	<div class="wap-container">
		<div class="panel">
			<div class="panel-body">
				<form action="{{route('landing.store')}}" method="post" class="form form-horizontal" id="form-admin-add">
				...
				<div class="row clearfix">
					<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>开工时间：</label>
					<div class="form-controls col-xs-8 col-sm-9">
				...
				submitHandler:function(form){
					$(form).ajaxSubmit({
						...
						success:function(data){
							if( data == '1'){
								layer.msg('项目开工成功！',{ icon: 1,time:2000},function(){
								...
								layer.msg('项目开工失败！',{ icon: 2,time:2000});
							}
						},
						error:function(XmlHttpRequest,textStatus,errorThrown){
							layer.msg('项目开工错误！',{ icon: 1,time:1000});
						},
					});
				},
			});
